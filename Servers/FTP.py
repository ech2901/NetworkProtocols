...
class FTPCommandHandler(BaseRequestHandler, Cmd):
    ...
    def do_list(self, arg):
        ...
        dir = list(scandir(f'{self.home}{self.selected}'))
        if dir:
            logging.info(dir)
            for entry in dir:
    ...
    def do_nlst(self, arg):
        ...
        dir = list(sorted(scandir(f'{self.home}{self.selected}')))
        if dir:
            logging.info(dir)
            for entry in dir:
                data = f'{entry.path}\r\n'
